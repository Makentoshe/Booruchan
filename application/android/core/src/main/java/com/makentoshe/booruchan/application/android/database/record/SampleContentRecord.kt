...
import com.makentoshe.booruchan.core.post.sampleContent

/** Contains sample content information in database for performing simple caching in file storage */
@Entity
data class SampleContentRecord(
    ...
    fun toContent() = sampleContent(url, height, width, extension, name)
}