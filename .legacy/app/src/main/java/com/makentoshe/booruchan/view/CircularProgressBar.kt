...
/*
 * This file is from the android-circular-progress-bar library that
 * mas made by korre(Kristoffer Matsson)
 * The library github repository: https://github.com/korre/android-circular-progress-bar
 */
