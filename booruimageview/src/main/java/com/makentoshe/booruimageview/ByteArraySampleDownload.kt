...
class ByteArraySampleDownload(
    ...
    private val cache = cacheBuilder.buildSampleCache()

    /** Returns a [ByteArray] by [Post] */
    override val repository = repositoryBuilder.buildSampleRepository(networkExecutor).wrapCache(cache)
}
