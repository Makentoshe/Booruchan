...
import com.makentoshe.booruchan.booru.content.factory.ContentFactory
...
class BooruActivityContentUI(style: Style,
    ...
    private fun _ConstraintLayout.createGallery(ui: AnkoContext<BooruActivity>) {
        frameLayout {
            ...
            panelViewModel.addSelectedItemPositionObserver(ui.owner) { contentID ->
                ...
                contentViewModel.addSearchTermObserver(ui.owner, fragmentView.onSearchStarted())
            }
