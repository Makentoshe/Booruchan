...
import com.makentoshe.booruchan.booru.view.content.comments.vertical.pager.CommentContentPageFragmentRecycleViewAdapterViewHolderUI
...
class CommentContentPageFragmentRecycleViewAdapter(
        private val list: List<Pair<Post, List<Comment>>>,
        private val previewLoader: PreviewLoader)
    : RecyclerView.Adapter<CommentContentPageFragmentRecycleViewAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = CommentContentPageFragmentRecycleViewAdapterViewHolderUI()
